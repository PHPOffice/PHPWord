...
class FontTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testFontNames1()
    {
        $phpWord = new PhpWord();
        $phpWord->setDefaultFontName('Courier New');
        $phpWord->setDefaultFontSize(12);
        $phpWord->addFontStyle('style1', array('name' => 'Tahoma', 'size' => 10, 'color' => '1B2232', 'bold' => true));
        $phpWord->addFontStyle('style2', array('name' => 'Arial', 'size' => 10));
        $phpWord->addFontStyle('style3', array('name' => 'hack attempt\'}; display:none', 'size' => 10));
        $phpWord->addFontStyle('style4', array('name' => 'padmaa 1.1', 'size' => 10, 'bold' => true));
        $phpWord->addFontStyle('style5', array('name' => 'MingLiU-ExtB', 'size' => 10, 'bold' => true));
     ...
     */
    public function testFontNames2()
    {
        $phpWord = new PhpWord();
        $phpWord->setDefaultFontName('Courier New');
        $phpWord->setDefaultFontSize(12);
        $phpWord->addFontStyle('style1', array('name' => 'Tahoma', 'size' => 10, 'color' => '1B2232', 'bold' => true));
        $phpWord->addFontStyle('style2', array('name' => 'Arial', 'size' => 10, 'htmlGenericFont' => 'sans-serif'));
        $phpWord->addFontStyle('style3', array('name' => 'DejaVu Sans Monospace', 'size' => 10, 'htmlGenericFont' => 'monospace'));
        $phpWord->addFontStyle('style4', array('name' => 'Arial', 'size' => 10, 'htmlGenericFont' => 'invalid'));
        $section1 = $phpWord->addSection();
        $section1->addText('Default font');
        $section1->addText('Tahoma', 'style1');
        $section1->addText('Arial', 'style2');
     ...
     */
    public function testFontNames3()
    {
        $phpWord = new PhpWord();
        $phpWord->setDefaultFontName('Courier New');
        $phpWord->setDefaultFontSize(12);
    ...
    public function testWhiteSpace()
    {
        ...
        $phpWord->addFontStyle('style1', array('name' => 'Courier New', 'size' => 10, 'htmlWhiteSpace' => 'pre-wrap'));
        $phpWord->addFontStyle('style2', array('name' => 'Courier New', 'size' => 10, 'htmlWhiteSpace' => 'invalid'));
        $phpWord->addFontStyle('style3', array('name' => 'Courier New', 'size' => 10, 'htmlWhiteSpace' => 'normal'));
        $phpWord->addFontStyle('style4', array('name' => 'Courier New', 'size' => 10, 'htmlWhiteSpace' => 'invalid'));
    ...
    {
        $phpWord = new PhpWord();
        $style1 = array('name' => 'Courier New', 'size' => 10, 'htmlWhiteSpace' => 'pre-wrap');
        $style2 = array('name' => 'Verdana', 'size' => 8.5);
    ...
    public function testLanguages()
    {
        ...
        $phpWord->addFontStyle('arabic', array('lang' => $langarabic));
        $langhindi = new Language('', 'hi-IN');
        $phpWord->addFontStyle('hindi', array('lang' => $langhindi, 'name' => 'Arial'));
        $phpWord->addFontStyle('nolang', array('name' => 'Verdana', 'size' => '10'));
        $section = $phpWord->addSection();
        $textrun = $section->addTextRun();
        $textrun->addText('سلام این یک پاراگراف راست به چپ است', array('rtl' => true, 'lang' => $langarabic));
        $section->addText('Ce texte-ci est en français.', array('lang' => 'fr-BE'));
        $section->addText('Ce texte-ci aussi.', array('lang' => 'fr-BE', 'name' => 'Verdana'));
