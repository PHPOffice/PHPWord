...
class ParagraphTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHeadingPageBreakBefore()
    {
        ...
        $this->assertEquals('Heading1', $doc->getElementAttribute($element, 'style:parent-style-name'));
        $element .= '/style:paragraph-properties';
        $this->assertTrue($doc->elementExists($element));
        $this->assertEquals('page', $doc->getElementAttribute($element, 'fo:break-before'));
        ...
        $this->assertEquals('Heading2', $doc->getElementAttribute($element, 'style:parent-style-name'));
        $element .= '/style:paragraph-properties';
        $this->assertTrue($doc->elementExists($element));
        $this->assertEquals('', $doc->getElementAttribute($element, 'fo:break-before'));
        ...
        $element .= '/text:span';
        $this->assertEquals('Heading1', $doc->getElementAttribute($element, 'text:style-name'));
        ...
        $element .= '/text:span';
        $this->assertEquals('Heading2', $doc->getElementAttribute($element, 'text:style-name'));
        ...
        $this->assertEquals('Heading2', $doc->getElementAttribute($element, 'style:name'));
        $this->assertEquals('paragraph', $doc->getElementAttribute($element, 'style:family'));
        $element .= '/style:paragraph-properties';
        $this->assertEquals('', $doc->getElementAttribute($element, 'fo:break-before'));
    }
