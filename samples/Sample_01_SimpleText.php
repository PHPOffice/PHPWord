...
$textrun->addText(', ');
$textrun->addText('underline', ['underline' => true, 'underlineColor' => 'FF0000']);
$textrun->addText(' ');
$textrun->addText('colour', ['underline' => true, 'underlineColor' => 'green']);
$textrun->addText(', ');
$textrun->addText('strikethrough', ['strikethrough' => true]);
$textrun->addText(', ');
$textrun->addText('doubleStrikethrough', ['doubleStrikethrough' => true]);
$textrun->addText(', ');
$textrun->addText('superScript x');
$textrun->addText('2', ['superScript' => true]);
$textrun->addText(', ');
$textrun->addText('subScript H');
$textrun->addText('2', ['subScript' => true]);
$textrun->addText('SO');
$textrun->addText('4', ['subScript' => true]);
$textrun->addText(', ');
