...
- Word2007 Reader/Writer : Added noWrap table cell property by [@kernusr](https://github.com/kernusr) in [2359](https://github.com/PHPOffice/PHPWord/issues/2359)
- HTML Reader : Support for `font-variant: small-caps` by [@cambraca](https://github.com/cambraca) in [2177](https://github.com/PHPOffice/PHPWord/issues/2117)
- Improved TextDirection for styling a cell by [@terryzwt](https://github.com/terryzwt) in [2429](https://github.com/PHPOffice/PHPWord/issues/2429)
- Word2007 Reader : Added option to disable loading images by [@aelliott1485](https://github.com/aelliott1485) in [2450](https://github.com/PHPOffice/PHPWord/issues/2450)
- HTML Writer : Added border-spacing to default styles for table by [@kernusr](https://github.com/kernusr) in [2451](https://github.com/PHPOffice/PHPWord/issues/2451)
- Word2007 Reader : Support for table cell borders and margins by [@kernusr](https://github.com/kernusr) in [2454](https://github.com/PHPOffice/PHPWord/issues/2454)
...
- Fixed wrong mimetype for docx files by [@gamerlv](https://github.com/gamerlv) in [2416](https://github.com/PHPOffice/PHPWord/issues/2416)
- Word2007 Reader : Read hyperlingks in headings by [@hannesdorn](https://github.com/hannesdorn) in [2433](https://github.com/PHPOffice/PHPWord/issues/2433)
- PclZip : strtr using empty string by [@spl1nes](https://github.com/spl1nes) in [2432](https://github.com/PHPOffice/PHPWord/issues/2432)
- Fixed PHP 8.2 deprecated about Allow access to an undefined property by [@DAdq26](https://github.com/DAdq26) in [2440](https://github.com/PHPOffice/PHPWord/issues/2440)
- Template Processor : Fixed choose dimention for Float Value by [@gdevilbat](https://github.com/gdevilbat) in [2449](https://github.com/PHPOffice/PHPWord/issues/2449)
- HTML Parser : Fix image parsing from url without extension by [@JokubasR](https://github.com/JokubasR) in [2459](https://github.com/PHPOffice/PHPWord/issues/2459)
...
- Added PHPStan by [@PowerKiKi](https://github.com/PowerKiKi) in [2045](https://github.com/PHPOffice/PHPWord/issues/2405)
- Bump symfony/process from 4.4.44 to 5.4.26 by [@dependabot](https://github.com/dependabot) in [2431](https://github.com/PHPOffice/PHPWord/issues/2431)
- Bump phpunit/phpunit from 9.6.8 to 9.6.10 by [@dependabot](https://github.com/dependabot) in [2430](https://github.com/PHPOffice/PHPWord/issues/2430)
- Added Coveralls.io by [@Progi1984](https://github.com/Progi1984) in [2452](https://github.com/PHPOffice/PHPWord/issues/2452)
- Added support for PHP 8.2 & PHP 8.3 by [@Progi1984](https://github.com/Progi1984) in [2453](https://github.com/PHPOffice/PHPWord/issues/2453)
- Moved documention from ReadTheDocs to MkDocs & Github Pages by [@Progi1984](https://github.com/Progi1984) in [2465](https://github.com/PHPOffice/PHPWord/issues/2465)
