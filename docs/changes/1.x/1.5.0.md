...
- Reader WPS: Read text from the Microsoft Works word processor documents by [@k4it00](https://github.com/k4it00) in [#2935](https://github.com/PHPOffice/PHPWord/pull/2935)
...
- Writer Word2007 & ODText: Escape bare ampersands so that text added by `Html::addHtml()` does not produce an invalid document by [@Bosun18](https://github.com/Bosun18) fixing [#2884](https://github.com/PHPOffice/PHPWord/issues/2884) in [#2931](https://github.com/PHPOffice/PHPWord/pull/2931)
