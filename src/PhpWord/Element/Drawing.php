...
use PhpOffice\PhpWord\Style\Drawing as DrawStyle;
...
class Drawing extends AbstractElement
{
     ...
     * Text style.
     *
     * @var \PhpOffice\PhpWord\Style\Drawing|string
     */
    protected $style;
     ...
     * @param mixed $style
     */
    public function __construct($style = null, $fontStyle = null)
    {
        $image = null;
        ...
        $this->setStyle($style);
        if ($fontStyle !== null) $this->setFontStyle($fontStyle);
        if ($image) {
            $this->setImage($image);
        }
    }
    ...
    {
        $this->fontStyle = new Font('text', $style);
     ...
     * Set Drawing style.
     *
     * @param array|\PhpOffice\PhpWord\Style\Drawing|string $style
     *
     * @return \PhpOffice\PhpWord\Style\Drawing|string
     */
